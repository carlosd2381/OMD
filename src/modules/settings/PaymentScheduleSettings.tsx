...
import { ArrowLeft, Plus, Trash2, Clock, Check, AlertCircle, Calendar } from 'lucide-react';
...
export default function PaymentScheduleSettings() {
  ...
  const [schedules, setSchedules] = useState<Schedule[]>([
    {
      id: '1',
      name: 'Standard Split',
      description: '35% Retainer, Balance 7 days before event',
      isDefault: true,
      milestones: [
        { id: 'm1', name: 'Retainer', percentage: 35, dueType: 'on_booking', daysOffset: 0 },
        { id: 'm2', name: 'Balance', percentage: 65, dueType: 'before_event', daysOffset: 7 },
      ]
    },
    {
      id: '2',
      name: 'Full Payment',
      description: '100% due on booking',
      isDefault: false,
      milestones: [
        { id: 'm3', name: 'Full Payment', percentage: 100, dueType: 'on_booking', daysOffset: 0 },
      ]
    }
  ]);
  ...
  const handleSave = async () => {
    ...
    toast.success('Payment schedules saved successfully');
    setLoading(false);
  };
  ...
  const handleDelete = (id: string) => {
    if (schedules.find(s => s.id === id)?.isDefault) {
          ...
          <div className="ml-3">
            ...
            <div className="mt-2 text-sm text-blue-700">
              <ul className="list-disc pl-5 space-y-1">
                ...
                <li>
                  <strong>Fixed Amounts:</strong> While these schedules use percentages, you can override specific amounts (like a fixed $5000 MXN retainer) directly on individual Quotes/Invoices.
                </li>
                <li>
