...
const THEME_MODES: Array<{ id: ThemeMode; icon: typeof Sun; label: string }> = [
    ...
    <div className="space-y-6">
      <div className="flex items-center justify-between">
        <div className="flex items-center space-x-4">
          ...
          <div>
            <h2 className="text-2xl font-bold text-gray-900 dark:text-white">Branding & Appearance</h2>
      ...
      <div className="grid grid-cols-1 gap-6 lg:grid-cols-2">
        ...
        <div className="space-y-6">
          ...
          <div className="bg-white dark:bg-gray-800 shadow sm:rounded-lg p-6">
            <h3 className="text-lg font-medium text-gray-900 dark:text-white mb-4">Display Mode</h3>
            <div className="grid grid-cols-3 gap-4">
              {THEME_MODES.map((mode) => (
                <button
                  key={mode.id}
                  onClick={() => setSettings({ ...settings, theme_mode: mode.id })}
          ...
          {/* Logo Upload */}
          <div className="bg-white dark:bg-gray-800 shadow sm:rounded-lg p-6">
            <h3 className="text-lg font-medium text-gray-900 dark:text-white mb-4">Brand Logo</h3>
            <div className="flex items-center space-x-6">
              <div className="shrink-0 h-24 w-24 border border-gray-200 dark:border-gray-700 rounded-lg overflow-hidden bg-gray-50 dark:bg-gray-700 flex items-center justify-center">
                {settings.logo_url ? (
                  ...
                  <div className="mt-1 flex justify-center px-6 pt-5 pb-6 border-2 border-gray-300 border-dashed rounded-md hover:border-primary transition-colors cursor-pointer relative">
                    <div className="space-y-1 text-center">
                      ...
                      <div className="flex text-sm text-gray-600">
                        <label
                          htmlFor="file-upload"
                          className="relative cursor-pointer bg-white dark:bg-gray-800 rounded-md font-medium text-primary hover:text-primary/80 focus-within:outline-none"
                        >
          ...
          {/* Company Name */}
          <div className="bg-white dark:bg-gray-800 shadow sm:rounded-lg p-6">
            <h3 className="text-lg font-medium text-gray-900 dark:text-white mb-4">Company Name</h3>
            <div>
        ...
        <div className="space-y-6">
          <div className="bg-white dark:bg-gray-800 shadow sm:rounded-lg p-6 sticky top-6">
            ...
            <div className="border border-gray-200 dark:border-gray-700 rounded-lg overflow-hidden">
              ...
              >
                <div className="flex items-center space-x-2">
                  <div className="h-6 w-6 bg-white dark:bg-gray-800/20 rounded-md"></div>
                  <div className="h-4 w-24 bg-white dark:bg-gray-800/20 rounded"></div>
                </div>
                <div className="h-8 w-8 bg-white dark:bg-gray-800/20 rounded-full"></div>
              </div>

              {/* Mock App Content */}
              <div className="p-4 bg-gray-50 dark:bg-gray-700 min-h-[300px] space-y-4">
                <div className="flex space-x-4">
                  ...
                  <div className="flex-1 space-y-4">
                    <div className="h-32 bg-white dark:bg-gray-800 rounded-lg shadow-sm p-4 space-y-3">
                    ...
                    <div className="grid grid-cols-2 gap-4">
                      <div className="h-24 bg-white dark:bg-gray-800 rounded-lg shadow-sm p-3 border-l-4" style={{ borderColor: settings.secondary_color }}>
                      ...
                      <div className="h-24 bg-white dark:bg-gray-800 rounded-lg shadow-sm p-3 border-l-4" style={{ borderColor: settings.accent_color }}>
                        <div className="h-4 w-1/2 bg-gray-100 rounded mb-2"></div>
                        <div className="h-8 w-8 rounded-full flex items-center justify-center" style={{ backgroundColor: settings.accent_color }}>
                          <div className="h-4 w-4 bg-white dark:bg-gray-800/50 rounded-full"></div>
                        </div>
                      </div>
                    </div>
                  </div>
