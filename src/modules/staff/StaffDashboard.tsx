        ...
        {activeTab === 'schedule' && (
          <div className="space-y-6">
            ...
            {upcomingAssignments.length === 0 ? (
              <p className="text-gray-500 dark:text-gray-400">No upcoming events assigned.</p>
            ) : (
              <div className="grid gap-4 sm:grid-cols-2 lg:grid-cols-3">
                {upcomingAssignments.map((assignment) => (
                  <div key={assignment.id} className="bg-white dark:bg-gray-800 overflow-hidden shadow rounded-lg">
