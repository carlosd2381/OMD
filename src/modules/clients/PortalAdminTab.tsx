      ...
      <div className="bg-white dark:bg-gray-800 shadow sm:rounded-lg overflow-hidden">
        ...
        <div className="px-4 py-5 sm:p-6 space-y-6">
          <div className="flex items-center justify-between">
            <div>
              <h4 className="text-sm font-medium text-gray-900 dark:text-white">Portal Status</h4>
          ...
          {client.portal_access && (
            <div className="grid grid-cols-1 gap-4 sm:grid-cols-3">
              <button
                ...
                disabled={loading}
                className="inline-flex items-center justify-center px-4 py-2 border border-gray-300 shadow-sm text-sm font-medium rounded-md text-gray-700 bg-white dark:bg-gray-800 hover:bg-gray-50 dark:bg-gray-700"
              >
          ...
          <div className="mt-4 text-sm text-gray-500 dark:text-gray-400 bg-gray-50 dark:bg-gray-700 p-3 rounded-md flex justify-between items-center">
