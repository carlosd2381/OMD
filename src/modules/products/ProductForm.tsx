...
export default function ProductForm({ product, onClose, onSubmit }: ProductFormProps) {
  ...
  return (
    <div className="fixed inset-0 bg-gray-50 dark:bg-gray-7000 bg-opacity-75 flex items-center justify-center p-4 z-50">
          ...
          <div className="grid grid-cols-1 gap-y-6 gap-x-4 sm:grid-cols-6">
            ...
            <div className="sm:col-span-3">
              ...
              <select
                ...
                className="mt-1 block w-full py-2 px-3 border border-gray-300 bg-white dark:bg-gray-800 rounded-md shadow-sm focus:outline-none focus:ring-primary focus:border-primary sm:text-sm"
              >
